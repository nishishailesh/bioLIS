...
function read_new_nc()
{
	...
	echo '		
				...
				<tr><td bgcolor=lightblue>current_status</td><td><textarea name=current_status rows=2 cols=80></textarea></tr>
...
function show_nc()
{
	...
	else
	{
		...
		<td bgcolor=lightblue>prevention</td>
                <td bgcolor=lightblue>current_status</td>
	...
	<td valign=top><textarea readonly name=prevention rows=4 cols=20>'.$array['prevention'].'</textarea>
        <td valign=top><textarea readonly name=current_status rows=4 cols=20>'.$array['current_status'].'</textarea>
